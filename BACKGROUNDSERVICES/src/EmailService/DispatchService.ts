...
const SendDispatch = async () => {
    ...
    for (let parcel of parcels) {
        ...
        ejs.renderFile('template/dispatch.ejs', { parcelid: parcel.parcel_id, senderemail: parcel.senderemail, fromLoc: parcel.fromLoc, delivery_date: parcel.delivery_date, toLoc: parcel.toLoc }, 
        async (error, data) => {
